    ...
    return (
        <div name='discord' className='discord'>
            ...
            <div className='discord-content'>
                ...
                <div className="content-point" data-aos="fade-left" data-aos-duration="1000">
                    <img src={logo} width={35} height={35} alt="Decentralized Learning" />
                    <div>
                        <h5>{t('discord.point1')}</h5>
                    </div>
                </div>
                <div className="content-point" data-aos="fade-left" data-aos-duration="1000">
                    <img src={logo} width={35} height={35} alt="Decentralized Learning" />
                    <div>
                        <h5>{t('discord.point2')}</h5>
                    </div>
                </div>
            </div>
        </div>
